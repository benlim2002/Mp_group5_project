...
import com.example.mp_group5_project.ui.home.filter.AsciiArtFilter;
import com.example.mp_group5_project.ui.home.filter.BasicDeformFilter;
import com.example.mp_group5_project.ui.home.filter.BlackAndWhiteFilter;
import com.example.mp_group5_project.ui.home.filter.BlueorangeFilter;
import com.example.mp_group5_project.ui.home.filter.CameraFilter;
import com.example.mp_group5_project.ui.home.filter.CartoonFilter;
import com.example.mp_group5_project.ui.home.filter.CastingFilter;
import com.example.mp_group5_project.ui.home.filter.ChromaticAberrationFilter;
import com.example.mp_group5_project.ui.home.filter.ContrastFilter;
import com.example.mp_group5_project.ui.home.filter.CrackedFilter;
import com.example.mp_group5_project.ui.home.filter.CrosshatchFilter;
import com.example.mp_group5_project.ui.home.filter.EMInterferenceFilter;
import com.example.mp_group5_project.ui.home.filter.EdgeDetectionFilter;
import com.example.mp_group5_project.ui.home.filter.GrayFilter;
import com.example.mp_group5_project.ui.home.filter.HexagonMosaicFilter;
import com.example.mp_group5_project.ui.home.filter.JFAVoronoiFilter;
import com.example.mp_group5_project.ui.home.filter.LegofiedFilter;
import com.example.mp_group5_project.ui.home.filter.LichtensteinEsqueFilter;
import com.example.mp_group5_project.ui.home.filter.MappingFilter;
import com.example.mp_group5_project.ui.home.filter.MirrorFilter;
import com.example.mp_group5_project.ui.home.filter.MoneyFilter;
import com.example.mp_group5_project.ui.home.filter.NegativeFilter;
import com.example.mp_group5_project.ui.home.filter.NoiseWarpFilter;
import com.example.mp_group5_project.ui.home.filter.NostalgiaFilter;
import com.example.mp_group5_project.ui.home.filter.OriginalFilter;
import com.example.mp_group5_project.ui.home.filter.PixelizeFilter;
import com.example.mp_group5_project.ui.home.filter.PolygonizationFilter;
import com.example.mp_group5_project.ui.home.filter.RefractionFilter;
import com.example.mp_group5_project.ui.home.filter.ReliefFilter;
import com.example.mp_group5_project.ui.home.filter.SwirlFilter;
import com.example.mp_group5_project.ui.home.filter.TileMosaicFilter;
import com.example.mp_group5_project.ui.home.filter.TrianglesMosaicFilter;
import com.example.mp_group5_project.ui.home.filter.TripleFilter;
import com.example.mp_group5_project.ui.home.filter.WaterReflectionFilter;
...
public class CameraRenderer implements Runnable, TextureView.SurfaceTextureListener {
    ...
    public void run() {
        ...
        // Render loop
        while (!Thread.currentThread().isInterrupted() && running && camera != null) {
            try {
